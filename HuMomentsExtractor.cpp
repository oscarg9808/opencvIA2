...
void HuMomentsExtractor::capture(){
	...
	video.set(CAP_PROP_FRAME_HEIGHT,600);
		...
		huMoments = this->extractHuMoments(frame);
	            ...
	            huMoments = this->extractHuMoments(frame, 88,87,86,180,201,243);
	            ...
	            if (indexRed!=-1){
	                ...
	                huMoments = this->extractHuMoments(frame,53,95,126,133,206,213);
	                ...
	                if (indexBlue!=-1){
	                    ...
	                    huMoments = this->extractHuMoments(frame,41,64,135,143,131,210);
